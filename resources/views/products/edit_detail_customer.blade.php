        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    <b class="card-title">Edit Detail Customer</b>
                </div>
                <div class="card-body">
                    @if (session('error'))
                    ...
                    <form action="{{ route('update.customerdetail', $details->id) }}" method="post">
                        @csrf
                        ...
                        <div class="form-group">
                            ...
                            <div class="form-group">
                             ...
                             @foreach ($users as $user)
                                <option value="{{ $user->id }}" {{ $user->id==$details->user_id ? 'selected':'' }}>{{ $user->name }} - {{ $user->email }}</option>
                             @endforeach
                            </select>
                            </div>
                        <div class="form-group">
