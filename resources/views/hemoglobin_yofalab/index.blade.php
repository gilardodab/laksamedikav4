            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        <div class="row">
                            <div class="col-md-6">
                                <b class="card-title">Hemoglobin Yofalab</b>
                            </div>
                            <div class="col-md-6">
                                <a href="{{ url('/hemoglobin-yofalab/new') }}" class="btn btn-primary btn-sm float-right">Add Data</a>
                            </div>
                            <div class="col-md-6">
                                <form action="{{ route('cari.hbyofalab') }}" method="GET" class="form-inline">
                        ...
                        <a class="btn btn-primary btn-sm float-right" href="{{ route('print.hbyofalab') }}"><span class="mdi mdi-printer">Print</span></a> 
                    </div>
                    ...
                    <div class="card-body">
                        ...
                        <table class="table table-hover table-bordered">
                            ...
                            <tbody>
                                ...
                                @forelse($hbyofalabs as $hbyofalab)
                                <tr>
                                    <!-- MENAMPILKAN VALUE DARI TITLE -->
                                    <td>{{ $hbyofalab->customer }}</td>
                                    <td>{{ $hbyofalab->address }}</td>
                                    <!-- TOMBOL DELETE MENGGUNAKAN METHOD DELETE DALAM ROUTING SEHINGGA KITA MEMASUKKAN TOMBOL TERSEBUT KEDALAM TAG <FORM></FORM> -->
                                    <td>
                                        <form class="btn-group" action="{{ url('/hemoglobin-yofalab/delete/' . $hbyofalab->id) }}" method="POST">
                                            <!-- @csrf ADALAH DIRECTIVE UNTUK MEN-GENERATE TOKEN CSRF -->
                                            @csrf
                                            <input type="hidden" name="_method" value="DELETE" class="form-control">
                                            <a href="{{ url('/hemoglobin-yofalab/detail/' . $hbyofalab->id) }}" class="btn btn-warning btn-sm"><i class="mdi mdi-pencil"></i></a>
                                            <a href="{{ route('lihat.hbyofalab', $hbyofalab->id) }}" class="btn btn-primary btn-sm"><i class="mdi mdi-eye"></i></a>
