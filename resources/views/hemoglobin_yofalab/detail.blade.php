...
@include('layouts.topNavBack')
            ...
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-body">
                            ...
                            <table class="table table-hover table-bordered">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <form class="btn-group" action="{{ url('/hemoglobin-yofalab/delete/detail/' . $detail->id) }}" method="POST">
                        ...
                        <div class="card-body">
                        <form action="{{ url('/hemoglobin-yofalab/save-detail/') }}" method="post">
                            @csrf
                            <input type="hidden" name="hemoglobin_yofalab_id" value="{{$hbyofalabs->id}}">
                            <input type="hidden" name="customer" value="{{$hbyofalabs->customer}}">
                            ...
                            <div class="form-group">
                                ...
                                <input type="date" id="Test_Date" name="tanggal" min="2015-12-01" max="2030-12-01" class="form-control {{ $errors->has('tanggal') ? 'is-invalid':'' }}" placeholder="Masukkan tanggal pemasangan alat" required>
                        ...
                        <br><br>
                        <a class="btn btn-danger btn-sm" id="buatdatahbyofalab" href="{{ url('/hemoglobin-yofalab') }}" role="button">Simpan Data</a>
                    </div>
                    </div>
                </div>
            </div>
    ...
    <script>
        $('#buatdatahbyofalab').on("click",function(){
